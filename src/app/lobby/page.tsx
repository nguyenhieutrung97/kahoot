      ...
      <main className="px-6 pb-6">
        ...
        {players.length > 0 && (
          <div className="mt-8 text-center">
            ...
            <button className="px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors">
              Start Game
            </button>
          </div>
        )}
